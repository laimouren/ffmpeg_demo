...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/root/ffmpeg_build --bindir=/root/bin --enable-nonfree --enable-pic --enable-shared --enable-avresample --disable-x86asm
...
LIBFUZZER_PATH=
IGNORE_TESTS=
avdevice_FFLIBS=avfilter swscale avformat avcodec swresample avresample avutil
avfilter_FFLIBS=swscale avformat avcodec swresample avresample avutil
