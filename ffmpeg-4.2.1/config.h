...
#define FFMPEG_CONFIGURATION "--prefix=/root/ffmpeg_build --bindir=/root/bin --enable-nonfree --enable-pic --enable-shared --enable-avresample --disable-x86asm"
...
#define CC_IDENT "gcc 10.3.1 (GCC)"
